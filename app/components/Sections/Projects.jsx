    ...
    <section className="w-11/12 md:max-w-2xl lg:max-w-3xl xl:max-w-4xl flex flex-col justify-end select-none mb-36">
      ...
      <div className="flex justify-center mt-16">
        <a
          ...
          className="border-2 border-gray-800 rounded-3xl py-2 px-4 text-lg font-semibold bg-[--bg-socialBtn] shadow-md shadow-black  hover:border-[--primary_a] hover:text-[--primary_a] transition-all duration-200 ease-in-out active:scale-95"
        >
          Más proyectos
        </a>
      </div>
